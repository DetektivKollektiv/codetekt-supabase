...
VALUES (
  ...
  '[
  {
    ...
    "fields": [
      ...
      {
        "id": "media_no_ai_or_staging_doubts",
        "type": "traffic-light",
        "question": "Die Bilder/Videos sind nicht offensichtlich manipuliert oder bearbeitet.",
        "options": [
          {
            "id": "traffic-light-opt-1",
            "value": 0,
        ...
        "options": [
          {
            ...
            "placeholder": "Beschreibe die zusätzlichen Punkte hier...",
            "max_length": 500
          }
        ],
        "is_required": [
  ...
  },
  {
    ...
    "fields": [
      ...
      },
      {
        "id": "content_language",
        "type": "traffic-light",
        "question": "Die Grammatik und Rechtschreibung sind fehlerfrei.",
        "options": [
          {
            "id": "traffic-light-opt-1",
            "value": 0,
  ...
  },
  {
    ...
    "fields": [
      {
        "id": "medium_independent_no_conflicts",
        "type": "traffic-light",
        "question": "Das Medium wirkt unabhängig. Es gibt keine Hinweise, dass finanzielle oder politische Interessen den Inhalt beeinflussen.",
        "options": [
          {
            "id": "traffic-light-opt-1",
            "value": 0,
      ...
      },
      {
        ...
        "type": "traffic-light",
        "question": "URL, Logo und Design passen zusammen und wirken authentisch. Die Seite gibt sich nicht als ein anderes bekanntes Medium aus.",
        "options": [
          {
            "id": "traffic-light-opt-1",
            "value": 0,
      ...
      {
        "id": "medium_no_aggressive_ads_or_trackers",
        "type": "traffic-light",
        "question": "Die Seite hat keine ungewöhnliche oder auffällge Tracker, Pop-Ups und/oder aggressive Werbung.",
        "options": [
          {
            "id": "traffic-light-opt-1",
            "value": 0,
      ...
      },
      {
        "id": "medium_impressum",
        "type": "traffic-light",
        "question": "Das Medium hat ein Impressum, inkl. Angabe von verantwortlichen Personen und Kontaktinformationen wie Telefonnummer und E-Mail-Adresse.",
        "options": [
          {
            "id": "traffic-light-opt-1",
            "value": 0,
        ...
        "shortTip": "Das Impressum ist in der Regel im Footer der Seite zu finden."
      },
      {
        "id": "medium_additional_points",
        "type": "traffic-light",
        "question": "Es gibt keine weiteren Punkte, die die Vertrauenswürdigkeit im Bereich Medium negativ beeinflussen.",
        "options": [
          {
            "id": "traffic-light-opt-1",
            "value": 0,
  ...
  },
  {
    ...
    "fields": [
      {
        "id": "source_article_author_expertise",
        "type": "traffic-light",
  ...
  },
  {
    ...
    "fields": [
      ...
      },
      {
        ...
        "type": "traffic-light",
        "question": "Die zitierten Expert*innen haben nachweislich eine Ausbildung, Beruf oder Erfahrung, zu diesem Thema.",
        "options": [
          {
            "id": "traffic-light-opt-1",
            "value": 0,
